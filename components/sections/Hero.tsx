...
const Hero = () => {
  return (
    ...
    >
            ...
            <div className="w-full lg:pl-[70px] px-5">
              <div className="py-1 mb-1">
                ...
                <p className="text-lg pl-1 pt-1">
                  A subscription website service for busy small-businesses
                  owners.
                </p>
              </div>
              {/* <p className="pb-5">
              ...
              <ul className="md:text-lg text-md pt-1">
                <li>
                  <b>-</b> Increased potential customers, easier to find on
                  Google
                </li>
                <li>
                  {" "}
                  <b>-</b> The ablity to tell your story and brand
                </li>
                <li>
                  {" "}
                  <b>-</b> Peace of mind... for business owners who {"don't"}{" "}
                  have time to build with software
                </li>
                <li>
                  {" "}
                  <b>-</b> A custom website that fits your business,
      ...
      <>
        {/* //todo later: MAKE VISIBLE WHEN CONTENT READY V
           <Dynamic_GridSqs
          ...
          SQparagraph4="Laughing Coyote is a subscription service that takes care of all your website brochure needs, if ever unsatisfied, you can cancel anytime"
           />  //todo later: MAKE VISIBLE WHEN CONTENT READY ^ */}
      </>
    </motion.section>
  );
};
