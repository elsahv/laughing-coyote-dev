...
const Hamburger = () => {
  ...
  return (  
        <div className="fixed top-0 mt-5 mr-5 right-0 mb-3 py-1 px-3 text-onyx hover:text-parchment dropshadow-2xl bg-[#ff7d00] border border-black hover:border-teal">
